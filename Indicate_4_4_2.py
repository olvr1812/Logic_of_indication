...
if v_s[0] == 1 or v_s[1] == 1 or v_s[2] == 1 or v_s[3] == 1:
   XKE_R = (p_s[0] * v_s[0] + p_s[0] * v_s[1] + p_s[0] * v_s[2] + p_s[0] * v_s[3]) / sum(v_s[:4])
   XKE_R_valid = 1
else:
   XKE_R_valid = 0
   XKE_R = 'Error'
...
if v_s[4] == 1 or v_s[5] == 1 or v_s[6] == 1 or v_s[7] == 1:
   XKV_R = (p_s[1] * v_s[4] + p_s[1] * v_s[5] + p_s[1] * v_s[6] + p_s[1] * v_s[7]) / sum(v_s[4:])
   XKV_R_valid = 1
else:
   XKV_R_valid = 0
   XKV_R = 'Error'

print('XKE_R = ', XKE_R, '\nXKE_R_valid = ', XKE_R_valid, '\nXKV_R = ', XKV_R, '\nXKV_R_valid = ', XKV_R_valid)