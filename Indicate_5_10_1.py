...
# Ввод переменных
xl_new = read_excel(config_path + '/logic.xlsx', sheet_name='5_10_1')
...
class app_5_10_1:
    ...
    def __init__(self, master):
        ...
        # Label menu
        self.img1 = Image.open(app_5_10_1.config_path + "/logo.png")
        self.img2 = Image.open(app_5_10_1.config_path + "/ssj1.png")
        self.img3 = Image.open(app_5_10_1.config_path + "/ssj2.png")
        ...
        for i in range(len(app_5_10_1.descriptSig)):
            ...
            exec('self.fr{} = Frame(self.fr_with_date, relief="ridge", bd=1, width=70)'.format(str(i)))
            ...
            exec('self.text{}1.insert(1.0, "{}")'.format(str(i), app_5_10_1.rangeSig[i]))
        ...
        self.result_lbl = Label(self.fr_results, text="Everything gone be alright")

        self.test1 = ttk.Button(self.fr_tests, text="Вариант 1", cursor="hand1", command=partial(self.tests, 1),
                                style="C.TButton")

        self.test2 = ttk.Button(self.fr_tests, text="Вариант 2", cursor="hand1", command=partial(self.tests, 2),
                                style="C.TButton")

        self.test3 = ttk.Button(self.fr_tests, text="Вариант 3", cursor="hand1", command=partial(self.tests, 3),
                                style="C.TButton")
        ...
        self.canvas = Canvas(self.fr_results, relief="ridge", bd=4, width=98, height=82)
